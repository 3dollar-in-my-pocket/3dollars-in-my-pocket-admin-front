...
import AdNoticeWarning from "@/components/push/AdNoticeWarning";
...
const PushManage = () => {
  ...
  return (
    <div>
      <PageHeader
        description="발송 대상과 푸시 타입을 지정해 메시지를 발송합니다. 오른쪽 미리보기로 실제 알림 모습을 실시간으로 확인할 수 있습니다."
        actions={
          <button className="btn btn-outline-primary" onClick={() => navigate("/info/push-statistics")}>
      ...
      <div className="push-layout">
        ...
        <aside className="push-layout__aside">
          <SectionCard title="미리보기" icon="bi-phone-fill"
                       description="입력한 내용이 실시간으로 반영됩니다.">
            <PushPreview
