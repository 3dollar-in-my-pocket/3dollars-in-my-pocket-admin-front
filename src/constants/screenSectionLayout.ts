...
export const STORE_DETAIL_SECTION_TYPES: SectionTypeMeta[] = [
  ...
  {value: 'CALLOUT', label: '콜아웃', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'RELATED_STORES', label: '연관 가게', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'AD_MOB', label: '애드몹 광고', isRequired: false, isConfigurable: true, allowsMultiple: true},
  {value: 'EDIT', label: '정보 수정', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'VISIT', label: '방문 인증', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'REVIEW', label: '리뷰', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'POST', label: '소식', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'IMAGE', label: '이미지', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'APPEARANCE_DAY', label: '출몰 요일', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'COUPON', label: '쿠폰', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'INFO', label: '가게 정보', isRequired: false, isConfigurable: true, allowsMultiple: false},
  {value: 'CTA', label: 'CTA 버튼', isRequired: false, isConfigurable: true, allowsMultiple: false},
